...
import (
	...
	"github.com/operator-framework/operator-registry/pkg/marketplace/clientset/versioned"
...
func NewClient(kubeconfig string, logger *logrus.Entry) (clientset versioned.Interface, err error) {
